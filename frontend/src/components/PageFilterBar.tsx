  ...
  return (
    <div>
      <div style={{
        ...
        {/* Абсолютный центр контентной области — одинаковая позиция на всех
            страницах независимо от длины заголовка и числа кнопок справа.
            transform создаёт свой контекст наложения, поэтому задаём ему z-index
